...
!function (a) {
    ...
    'moment'], a) : 'object' == typeof exports ? module.exports = a(require('jquery'), require('moment')) : a(jQuery, moment)
}(function (a, b) {
    function c(a) {
        return Q(a, Ra)
    }
    ...
    function A(b) {
        ...
        for ('string' == typeof b ? f = b.split(/\s*,\s*/) : 'function' == typeof b ? f = [
          b
        ] : a.isArray(b) && (f = b), c = 0; c < f.length; c++) d = f[c],
    ...
    function Q(a, b) {
        ...
        if (b) for (c = 0; c < b.length; c++) {
            for (d = b[c], e = [
            ], f = a.length - 1; f >= 0; f--) if (g = a[f][d], 'object' == typeof g) e.unshift(g);
            else if (void 0 !== g) {
                i[d] = g;
                break
            }
    ...
    function ea(c, d, e) {
        ...
        return b.isMoment(j) ? (i = b.apply(null, c), ga(j, i)) : O(j) || void 0 === j ? i = b.apply(null, c) : (f = !1, g = !1, k ? Za.test(j) ? (j += '-01', c = [
          j
        ], f = !0, g = !0) : (h = $a.exec(j)) && (f = !h[5], g = !0) : a.isArray(j) && (g = !0), i = d || f ? b.utc.apply(b, c) : b.apply(null, c), f ? (i._ambigTime = !0, i._ambigZone = !0) : e && (g ? i._ambigZone = !0 : k && (i.utcOffset ? i.utcOffset(j) : i.zone(j)))),
        i._fullCalendar = !0,
        i
    }
    function fa(a, c) {
    ...
    function ma(a, b, c, d, e) {
        var f;
        return a = Pa.moment.parseZone(a),
    ...
    function qa(a) {
        for (var b, c = [
        ], d = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; b = d.exec(a) ;) b[1] ? c.push(b[1]) : b[2] ? c.push({
            maybe: qa(b[2])
        }) : b[3] ? c.push({
            token: b[3]
        }) : b[5] && c.push(b[5]);
    ...
    function sa(a, b) {
        var c;
        return U(b, 'constructor') && (c = b.constructor),
    ...
    function Fa(a) {
        ...
        e,
        f;
        for (b = 0; b < a.length; b++) for (c = a[b], d = 0; d < c.length; d++) for (e = c[d], e.forwardSegs = [
    ...
    function Ja(c, d) {
        ...
        function i(b) {
            ...
            !W && b && (W = N.view = ba[b] || (ba[b] = N.instantiateView(b)), W.setElement(a('<div class=\'fc-view fc-' + b + '-view\' />').appendTo(U)), S.activateButton(b)),
            W && (Z = W.massageCurrentDate(Z), W.displaying && Z.isWithin(W.intervalStart, W.intervalEnd) || h() && (W.display(Z), I(), u(), v(), q())),
            I(),
            ca--
        }
        function j(a) {
        ...
        function l() {
            X = 'number' == typeof O.contentHeight ? O.contentHeight : 'number' == typeof O.height ? O.height - (T ? T.outerHeight(!0) : 0) : Math.round(U.width() / Math.max(O.aspectRatio, 0.5))
        }
        function m(a) {
        ...
        N.moment = function () {
            var a;
            return 'local' === O.timezone ? (a = Pa.moment.apply(null, arguments), a.hasTime() && a.local()) : a = 'UTC' === O.timezone ? Pa.moment.utc.apply(null, arguments) : Pa.moment.parseZone.apply(null, arguments),
        ...
        function f(d) {
            ...
            return f && a.each(f.split(' '), function (d) {
                ...
                a.each(this.split(','), function (d, e) {
                    ...
                    })[e], l = c.buttonText[e]), j && (m = f ? f.themeIcon : c.themeButtonIcons[e], o = f ? f.icon : c.buttonIcons[e], q = k ? Y(k) : m && c.theme ? '<span class=\'ui-icon ui-icon-' + m + '\'></span>' : o && !c.theme ? '<span class=\'fc-icon fc-icon-' + o + '\'></span>' : Y(l), r = [
                      'fc-' + e + '-button',
                      n + '-button',
                      n + '-state-default'
    ...
    function Na(c) {
        ...
        function p(a, b) {
            ...
            f = s(a);
            if (f) {
                for (c = w(f), d = 0; d < c.length; d++) e = c[d],
        ...
        function s(d, e) {
            ...
            if (c.eventDataTransform && (d = c.eventDataTransform(d)), e && e.eventDataTransform && (d = e.eventDataTransform(d)), a.extend(i, d), e && (i.source = e), i._id = d._id || (void 0 === d.id ? '_fc' + vb++ : d.id + ''), d.className ? 'string' == typeof d.className ? i.className = d.className.split(/\s+/) : i.className = d.className : i.className = [
            ], f = d.start || d.date, g = d.end, P(f) && (f = b.duration(f)), P(g) && (g = b.duration(g)), d.dow || b.isDuration(f) || b.isDuration(g)) i.start = f ? b.duration(f) : null,
        ...
        function v(a) {
            ...
            a.allDay ? (a.start.stripTime(), a.end && a.end.stripTime()) : (a.start.hasTime() || (a.start = K.applyTimezone(a.start.time(0))), a.end && !a.end.hasTime() && (a.end = K.applyTimezone(a.end.time(0))))
        }
        function w(b, c, d) {
            var e,
            f,
    ...
    _a.stripTime = function () {
        var a;
        return this._ambigTime || (a = this.toArray(), this.utc(), Wa(this, a.slice(0, 3)), this._ambigTime = !0, this._ambigZone = !0),
        this
    },
    _a.hasTime = function () {
    ...
    _a.stripZone = function () {
        var a,
        b;
        return this._ambigZone || (a = this.toArray(), b = this._ambigTime, this.utc(), Wa(this, a), this._ambigTime = b || !1, this._ambigZone = !0),
        this
    },
    _a.hasZone = function () {
    ...
    _a.local = function () {
        var a = this.toArray(),
        b = this._ambigZone;
        return ab.local.apply(this, arguments),
        this._ambigTime = !1,
        this._ambigZone = !1,
        b && Xa(this, a),
        this
    ...
    _a.utc = function () {
        return ab.utc.apply(this, arguments),
        this._ambigTime = !1,
        this._ambigZone = !1,
        this
    },
    ...
    _a.isSame = function (a, b) {
        var c;
        return this._fullCalendar ? b ? (c = fa([this,
        a], !0), ab.isSame.call(c[0], c[1], b)) : (a = Pa.moment.parseZone(a), ab.isSame.call(this, a) && Boolean(this._ambigTime) === Boolean(a._ambigTime) && Boolean(this._ambigZone) === Boolean(a._ambigZone)) : ab.isSame.apply(this, arguments)
    },
    a.each(['isBefore',
    'isAfter'], function (a, b) {
        _a[b] = function (a, c) {
            var d;
            return this._fullCalendar ? (d = fa([this,
            a]), ab[b].call(d[0], d[1], c)) : ab[b].apply(this, arguments)
        }
    }),
    ...
    hb = Pa.DragListener = ra.extend({
        ...
        updateScroll: function (a) {
            ...
            h = 0,
            i = 0;
            g && (b = (f - (a.pageY - g.top)) / f, c = (f - (g.bottom - a.pageY)) / f, d = (f - (a.pageX - g.left)) / f, e = (f - (g.right - a.pageX)) / f, b >= 0 && 1 >= b ? h = b * this.scrollSpeed * -1 : c >= 0 && 1 >= c && (h = c * this.scrollSpeed), d >= 0 && 1 >= d ? i = d * this.scrollSpeed * -1 : e >= 0 && 1 >= e && (i = e * this.scrollSpeed)),
    ...
    ib = hb.extend({
        ...
        dragStop: function () {
            this.hitDone(),
            hb.prototype.dragStop.apply(this, arguments)
        },
        hitOver: function (a) {
        ...
        scrollStop: function () {
            hb.prototype.scrollStop.apply(this, arguments),
            this.computeCoords()
        },
    ...
    kb.mixin({
        ...
        renderEvents: function (a) {
            ...
            this.segs = [
            ].concat(this.renderBgEvents(c), this.renderFgEvents(d))
        },
        ...
        eventToSpan: function (a) {
            ...
            return this.transformEventSpan(b, a),
            b
        },
        eventsToSegs: function (b, c) {
            ...
            return a.each(e, function (a, b) {
                ...
                if (xa(b[0])) for (g = d.invertRanges(g), e = 0; e < g.length; e++) d.generateEventSegs(g[e], b[0], c, f);
                else for (e = 0; e < g.length; e++) d.generateEventSegs(g[e], b[e], c, f)
            }),
            f
        },
        ...
        invertRanges: function (a) {
            ...
            h = e;
            for (a.sort(Aa), b = 0; b < a.length; b++) c = a[b],
            c.start > h && g.push({
                start: h,
                end: c.start
            }),
    ...
    var lb = Pa.DayTableMixin = {
        ...
        updateDayTable: function () {
            for (var a, b, c, d = this.view, e = this.start.clone(), f = -1, g = [
            ], h = [
            ]; e.isBefore(this.end) ;) d.isHiddenDay(e) ? g.push(f + 0.5) : (f++, g.push(f), h.push(e.clone())),
            e.add(1, 'days');
        ...
        renderHeadDateCellsHtml: function () {
            ...
            for (a = 0; a < this.colCnt; a++) b = this.getCellDate(0, a),
        ...
        renderBgCellsHtml: function (a) {
            ...
            for (b = 0; b < this.colCnt; b++) c = this.getCellDate(a, b),
        ...
        renderBgCellHtml: function (a) {
            ...
            return c.unshift('fc-day', b.widgetContentClass),
            '<td class="' + c.join(' ') + '" data-date="' + a.format('YYYY-MM-DD') + '"></td>'
        },
    ...
    mb = Pa.DayGrid = kb.extend(lb, {
        ...
        spanToSegs: function (a) {
            ...
            for (b = 0; b < d.length; b++) c = d[b],
            this.isRTL ? (c.leftCol = this.daysPerRow - 1 - c.lastRowDayIndex, c.rightCol = this.daysPerRow - 1 - c.firstRowDayIndex) : (c.leftCol = c.firstRowDayIndex, c.rightCol = c.lastRowDayIndex);
            return d
        },
        prepareHits: function () {
        ...
        renderDrag: function (a, b) {
            ...
            b && !b.el.closest(this.el).length ? (this.renderEventLocationHelper(a, b), this.applyDragOpacity(this.helperEls), !0) : void 0
        },
        unrenderDrag: function () {
            this.unrenderHighlight(),
            this.unrenderHelper()
        ...
        renderFill: function (b, c, d) {
            ...
            for (c = this.renderFillSegEls(b, c), e = 0; e < c.length; e++) f = c[e],
        ...
        renderSegRow: function (b, c) {
            ...
            for (e = 0; n > e; e++) {
                if (f = m[e], g = 0, h = a('<tr/>'), p.push([]), q.push([]), r.push([]), f) for (i = 0; i < f.length; i++) {
                    for (j = f[i], d(j.leftCol), k = a('<td class="fc-event-container"/>').append(j.el), j.leftCol != j.rightCol ? k.attr('colspan', j.rightCol - j.leftCol + 1) : r[e][g] = k; g <= j.rightCol;) q[e][g] = k,
                    p[e][g] = j,
                    g++;
                    h.append(k)
                }
    ...
    mb.mixin({
        ...
        limitRows: function (a) {
            ...
            for (b = 0; b < d.length; b++) this.unlimitRow(b),
        ...
        limitRow: function (b, c) {
            ...
            if (c && c < u.segLevels.length) {
                for (e = u.segLevels[c - 1], f = u.cellMatrix, g = u.tbodyEl.children().slice(c).addClass('fc-limited').get(), h = 0; h < e.length; h++) {
                    for (i = e[h], d(i.leftCol), l = [
                    ], k = 0; w <= i.rightCol;) j = this.getCellSegs(b, w, c),
                    l.push(j),
                    k += j.length,
                    w++;
                    if (k) {
                        for (m = f[c - 1][i.leftCol], n = m.attr('rowspan') || 1, o = [
                        ], p = 0; p < l.length; p++) q = a('<td class="fc-more-cell"/>').attr('rowspan', n),
                        j = l[p],
                        s = this.renderMoreLink(b, i.leftCol + p, [
                          i
                        ].concat(j)),
                        r = a('<div/>').append(s),
                        q.append(r),
        ...
        getCellSegs: function (a, b, c) {
            for (var d, e = this.rowStructs[a].segMatrix, f = c || 0, g = [
            ]; f < e.length;) d = e[f][b],
            d && g.push(d),
            f++;
            return g
    ...
    var nb = Pa.TimeGrid = kb.extend(lb, {
        ...
        sliceRangeByTimes: function (a) {
            ...
            for (c = 0; c < this.daysPerRow; c++) d = this.dayDates[c].clone(),
            e = {
        ...
        renderFill: function (b, c, d) {
            ...
            n;
            if (c.length) {
                for (c = this.renderFillSegEls(b, c), e = this.groupSegCols(c), d = d || b.toLowerCase(), f = a('<div class="fc-' + d + '-skeleton"><table><tr/></table></div>'), g = f.find('tr'), h = 0; h < e.length; h++) if (i = e[h], j = a('<td/>').appendTo(g), i.length) for (k = a('<div class="fc-' + d + '-container"/>').appendTo(j), l = this.getCellDate(0, h), m = 0; m < i.length; m++) n = i[m],
                k.append(n.el.css({
    ...
    nb.mixin({
        ...
        renderSegTable: function (b) {
            ...
            for (c = this.groupSegCols(b), this.computeSegVerticals(b), f = 0; f < c.length; f++) {
                for (g = c[f], this.placeSlotSegs(g), h = a('<div class="fc-event-container"/>'), d = 0; d < g.length; d++) e = g[d],
                e.el.css(this.generateSegPositionCss(e)),
                e.bottom - e.top < 30 && e.el.addClass('fc-short'),
                h.append(e.el);
                j.append(a('<td/>').append(h))
            }
            return this.bookendCells(j),
            i
        },
        ...
        fgSegHtml: function (a, b) {
            ...
            f.isMultiDayEvent(g) ? (a.isStart || a.isEnd) && (c = this.getEventTimeText(a), d = this.getEventTimeText(a, 'LT'), e = this.getEventTimeText(a, null, !1)) : (c = this.getEventTimeText(g), d = this.getEventTimeText(g, 'LT'), e = this.getEventTimeText(g, null, !1)),
    ...
    var ob = Pa.View = ra.extend({
        ...
        computeRange: function (a) {
            ...
            return /year|month|week|day/.test(d) ? (e.stripTime(), f.stripTime()) : (e.hasTime() || (e = this.calendar.time(0)), f.hasTime() || (f = this.calendar.time(0))),
            b = e.clone(),
        ...
        massageCurrentDate: function (a, b) {
            return this.intervalDuration.as('days') <= 1 && this.isHiddenDay(a) && (a = this.skipHiddenDays(a, b), a.startOf('day')),
            a
        },
        ...
        reportExternalDrop: function (b, c, d, e, f) {
            ...
            i = b.eventProps;
            i && (g = a.extend({
            }, i, c), h = this.calendar.renderEvent(g, b.stick)[0]),
    ...
    pb = Pa.Calendar = ra.extend({
        ...
        buildViewSpecButtonText: function (a, b) {
            ...
            a.buttonTextDefault = c(this.langDefaults) || c(this.dirDefaults) || a.defaults.buttonText || c(pb.defaults) || (a.duration ? this.humanizeDuration(a.duration) : null) || b
        },
    ...
    var zb = Pa.AgendaView = ob.extend({
        ...
        updateSize: function (a) {
            ...
            ob.prototype.updateSize.call(this, a)
        },
        updateWidth: function () {
        ...
        setHeight: function (a, b) {
            ...
            this.dayGrid && (this.dayGrid.removeSegPopover(), c = this.opt('eventLimit'), c && 'number' != typeof c && (c = Cb), c && this.dayGrid.limitRows(c)),
            b || (d = this.computeScrollerHeight(a), l(this.scrollerEl, d) ? (e(this.noScrollRowEls, r(this.scrollerEl)), d = this.computeScrollerHeight(a), this.scrollerEl.height(d)) : (this.scrollerEl.height(d).css('overflow', 'hidden'), this.bottomRuleEl.show()))
        },
